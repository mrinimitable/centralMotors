					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">Collect To Customer</th>
								...
								<th style="text-align: center;">Date</th>
								<th style="text-align: center;">RTO Name</th>
								<th style="text-align: center;">Send To Rto</th>
								...
								<th style="text-align: center;">Receive From Rto</th>
								<th style="text-align: center;">RC No</th>
								...
								<th style="text-align: center;">Dispatch To Customer</th>
								<th style="text-align: center;">RC</th>
								<th style="text-align: center;">Date</th>
								<th style="text-align: center;">Permit</th>
								<th style="text-align: center;">Date</th>
						...
						<tbody style="background: #fff;">
							...
							<tr>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getCustomer_given_status()%></td>
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getAdhar_no()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_adhar_card()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getReceive_adhar_card_date(), "yyyy-mm-dd",
						"dd-mm-yyyy")%></td>


								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getPan_card_no()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_pan_card()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getReceive_pan_card_date(), "yyyy-mm-dd",
						"dd-mm-yyyy")%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_paichay_patr()%></td>


								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getReceive_paichay_patr_date(), "yyyy-mm-dd",
						"dd-mm-yyyy")%></td>



								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_photo()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getReceive_photo_date(), "yyyy-mm-dd", "dd-mm-yyyy")%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getSend_to_rto_status()%></td>
						...
						dto.getSend_photo_date(), "yyyy-mm-dd", "dd-mm-yyyy")%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_from_rto_status()%></td>
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getRc_no()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_rc()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getReceive_rc_date(), "yyyy-mm-dd", "dd-mm-yyyy")%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getPermit_no()%></td>
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_permit()%></td>


								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getReceive_permit_date(), "yyyy-mm-dd",
						"dd-mm-yyyy")%></td>
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getReceive_fitness()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getReceive_fitness_date(), "yyyy-mm-dd",
						"dd-mm-yyyy")%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getDispatch_customer_status()%></td>




								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getDispatch_rc()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getDispatch_rc_date(), "yyyy-mm-dd", "dd-mm-yyyy")%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getDispatch_permit()%></td>
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getDispatch_permit_date(), "yyyy-mm-dd",
						"dd-mm-yyyy")%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getDispatch_fitness()%></td>
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getDispatch_fitness_date(), "yyyy-mm-dd",
						"dd-mm-yyyy")%></td>
								...
								<%-- <td style="text-align: center;"><a
												href="rto_paper_update.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>"><i
