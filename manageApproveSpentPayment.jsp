...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Payment Approve Request</h3>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<SpentDto> list = service
										.getAllApproverSpentAmountOnlyCash(branch_id, config,
												request);
							...
							<tr>
								...
								<td style="text-align: center;"><a
									href="approve_spend_payment.jsp?id=<%=dto.getId()%>&&check=1">Pay
										Amount </a></td>
								<td
