...
<body>
	...
	<h3 style="text-align: center;">Pay Workshop Credit Amount</h3>
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="customer_mobile_no"
								id="customer_mobile_no" placeholder="customer_mobile"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="insurance_credit_date"
								...
								value="<%=dto.getPromish_sate()%>" class="form-control">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="balance_amount" id="balance_amount"
								...
								value="<%=(dto.getBalance_amount() + dto
	...
	<script type="text/javascript">
		...
		function getfinanceBranchName(){
			...
			var total=((10*tens)+(20*twenty)+(50*fifty)+(100*hundred)+(500*fivehundred)+(2000*twothosunad)+(200*Twohundred) - 
					(10*Returntens)-(20*Returntwenty)-(50*Returnfifty)-(100*Returnhundred)-(500*Returnfivehundred)-
					(2000*Returntwothosunad)-(200*ReturnTwohundred)-(1*ReturnCoin_1));
