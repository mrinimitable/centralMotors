...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Manage Paid Deposit Finance</h3>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<PurchaseVehicleDto> list = service
										.getDepositcustomerCreditByID(id, config, request);
							...
							<tr>
								...
								<td
									...
									href="receipt_customer_credit_balance.jsp?id=<%=dto.getId()%>">Print
								</a></td>
