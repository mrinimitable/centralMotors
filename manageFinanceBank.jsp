...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Manage Finance Bank</h3>
		
		
		
		<div class="col-md-12" style="text-align: center;">

			</br> <a href="addFinanceBank.jsp" class="submit"><button class="submit">Add Finance Bank </button></a>
		</div>
...
<%
											...
											ArrayList<FinanceBankDto>list= service.getAllFianaceBank(config, request);
												for(FinanceBankDto dto : list){
										...
										<tr>
											...
											<td style="text-align: center;">
											 <a href="editFinanceBank.jsp?id=<%=dto.getId()%>"> 
