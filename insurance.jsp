...
<body>
	...
	<h3 style="text-align: center;">Add Insurance</h3>
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										...
										<input type="text" value="<%=dto.getVehical_id()%>"
											...
											type="hidden" name="Vehicle_id_fk" value="<%=id%>">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="customer_mobile_no"
											...
											class="form-control"
											value="<%=dto.getCustomer_mobile_no()%>">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="customer_gstIn"
											id="customer_gstIn" placeholder="customer_gstIn"
											class="form-control"
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="insurance_date" id="insurance_date"
											placeholder="Insurance Date" value="<%=cur_date%>"
											class="form-control">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="cover_note_no" id="cover_note_no"
											placeholder="Cover Note No" value=""
											class="form-control">
