...
<body>
	...
	<h3 style="text-align: center;">Add Other Charges Reference No</h3>
						...
						<div class="right_side">
							<form action="ExchangeBonusServlet" id="new" method="post">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										...
										<input type="text" value="<%=dto.getVehical_id()%>"
											...
											type="hidden" name="update_status_id" value="5">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="dms_reference_no"
											id="dms_reference_no" placeholder="dms_reference_no" value=""
											class="form-control">
