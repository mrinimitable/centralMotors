	...
	<table>
		<tbody>
			...
			<%
				...
				OldVehicleDto dto = pur_service
						.getDepositOldVehiclecustomerCreditByDipositID(id, request,
								config);
			%>
			...
			<tr>
				<td><div>
					...
					<div>
						<a href="customer_credit_report_old_vehicle.jsp"> <input
							value="Home" class="sbmit_blue" type="button">
						</a>
					</div></td>
			</tr>
		</tbody>
			...
			<div style="float: left; width: 100%;">
				...
				<div
					...
					<div style="float: left; width: 62%; font-size: 11px;">
						...
						<div>
							<b>Recipt No.:</b> <span style="text-transform: capitalize;"><%=dto.getId()%></span>
						</div>
				...
				<div
					...
					<div style="float: left; width: 100%; font-size: 11px;">
						...
						<div>
							<b>From.:</b> <span style="text-transform: capitalize;"><%=dto.getCustmer_name_sale()%></span>
						</div>
				...
				<div
					...
					<div style="float: left; width: 100%; font-size: 11px;">
						...
						<div>
							<b>Payment of Our Billl No.:</b> <span
								style="text-transform: capitalize;"><%=dto.getRemark()%></span>
						</div>
					...
					<div style="float: left; width: 100%; font-size: 11px;">
						...
						<div>
							<b> The Sum Of Rupees:- Rs.</b> <span
								style="text-transform: capitalize;"><b><%=dto.getPay_amount()%></b></span>
						</div>
