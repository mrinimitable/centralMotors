...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Extended Warranty</h3>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
										...
										<%
											...
											ArrayList<DamageVehicleDto> list = service.getPendingExtended_warranty(
										...
										<tr>
											...
											<td
												...
												href="add_extended_warranty_dms_reference_no.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
													 Entry </a></td>
