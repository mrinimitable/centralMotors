...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Credit Note Exchange Bonus</h3>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
										...
										<%
											...
											ArrayList<DamageVehicleDto> list = service.getPendingCreditNoteExchangeBonus(branch_id, config, request);
						...
						dto.getCredit_note_date(), "yyyy-mm-dd", "dd-mm-yyyy")%></td>
											...
											<td
												...
												href="add_exchange_bonus_credit.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
													Credit Entry </a></td>
