...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Other Charges</h3>
...
<tr>
						...
						<tbody style="background: #fff;">
										...
										<%
											...
											ArrayList<DamageVehicleDto> list = service.getPendingOtherCharges(
										...
										<tr>
											...
											<td
												...
												href="add_other_charges_dms_reference_no.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
													Entry </a></td>
