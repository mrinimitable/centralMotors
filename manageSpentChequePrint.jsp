...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Print Cheque Spend</h3>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<SpentDto> list = service.getAllSpentCompleteNotOnlyCashReport(
 ...
 %> </a>
								...
								<%
									if (dto.getCheck_no().equals("0")) {
								%>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><a
									href="Check_no_update.jsp?id=<%=dto.getId()%>"><%=dto.getCheck_no()%></a></td>
