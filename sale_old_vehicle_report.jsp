...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Sold Old Vehicle Stock</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							<tr>
								...
								<th style="text-align: center;" width="4%">Sale</th>
								...
								<th style="text-align: center;" width="10%">Owner Name</th>
								<th style="text-align: center;" width="10%">Owner Mobile No</th>
								<th style="text-align: center;" width="10%">Owner Address</th>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<OldVehicleDto> list = service.getAllApproveOldVehicle(
										config, request);
							...
							<tr>
								...
								<td
									...
									<a href="sale_old_vehicle_sale.jsp?id=<%=dto.getId()%>">Sale
								</a>
								</td>
								...
								<td
									...
									<%=LogFileService.changeFormate(dto.getExchange_date(),
