...
<body>
	...
	<div class="row_my">
		...
		<div class="col-md-12" style="text-align: center;">
			...
			</br> <a href="add_Only_Varient.jsp" class="submit"><button
					class="submit">Add Varient</button></a>
		</div>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							...
							<tr>
								...
								<td style="text-align: center;"><%=dto.getModel()%></td>

								<td style="text-align: center; text-transform: capitalize;"><%=dto.getSTATUS()%></td>
								<td style="text-align: center;"><a
									href="editOnlyVarient.jsp?id=<%=dto.getId()%>"> <i
