	...
	<div class="col-md-12">
		...
		<div class="col-md-8" style="padding: 0px;">
			...
			<div class="right_side">
				...
				<form action="FinanceServlet" enctype="multipart/form-data" id="new"
					method="post">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="hidden" name="creator_id_fk" id="creator_id_fk"
								...
								name="Vehicle_id_fk" id="Vehicle_id_fk" value="<%=Vehicle_id%>">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="text" name="finance_amount" id="finance_amount "
								value="<%=dto.getFinance_amount()%>" class="form-control"
								readonly="readonly">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="receive_amount" id="receive_amount"
								placeholder="receive_amount" value="" class="form-control">
					...
					<div class=" col-md-12 ">
						...
						<table style="width: 100%">
							<tr align="center">
								<td><input type="radio" value="Cheque" name="payment_mode"
