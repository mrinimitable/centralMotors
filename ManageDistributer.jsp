...
<body>
	...
	<div class="row_my">
		...
		<div class="col-md-12" style="text-align: center;">
			...
			</br> <a href="add_distributer.jsp" class="submit"><button
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<DistributorDto> list = service.getAllDistributor(config,
										request);
							...
							<tr>
								...
								<td style="text-align: center;"><a
									href="editDistributer.jsp?id=<%=dto.getId()%>"> <i
