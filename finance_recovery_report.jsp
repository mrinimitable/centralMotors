					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">Finance Recovery</th>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<FinanceDto> list = service.getfinance_recovery(branch_id,
										config, request);
							...
							<tr>
								...
								<td
									...
									href="finance_credit.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
										Credit Entry </a></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><a
									href="finance.jsp?id=<%=dto.getId()%>"><%=dto.getDo_no()%></a></td>
