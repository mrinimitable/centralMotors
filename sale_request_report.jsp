					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							<tr>
								...
								<th style="text-align: center; display: none;">Cash Diposit
									Amount</th>
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<PurchaseVehicleDto> list = service.getAllSaleRequest(
										config, request);
							...
							<tr>
								...
								<td
									...
									href="varify_sale_request.jsp?id=<%=dto.getId()%>"> Varify </a></td>



								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(dto.getSaleing_date(),
						...
						.getBooking_amount()%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold; display: none;"><%=dto.getDiposit_amount()%></td>
						...
						.getDiposit_cheaqe_reamrk()%></td>
								...
								<td style="text-align: center; display: none;"><a href="#"><i
