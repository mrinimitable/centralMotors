	...
	<table>
		<tbody>
			<%
				...
				PurchaseVehicleDto dto = pur_service
						.getDepositcustomerCreditByDipositID(id, request, config);
			%>
			...
			<tr>
				<td><div>
					...
					<div>
						<a href="customer_credit_report.jsp"> <input value="Home"
			...
			<div style="float: left; width: 100%;">
				...
				<div
					...
					<div style="width: 38%; font-size: 11px; float: right;">
						...
						<div>
							<b>Date: <%=LogFileService.changeFormate(dto.getPay_date(),
				...
				<div
					...
					<div style="float: left; width: 100%; font-size: 11px;">
						...
						<div>
							<b>From.:</b> <span style="text-transform: capitalize;"><%=dto.getCustomer_name()%></span>
						</div>
