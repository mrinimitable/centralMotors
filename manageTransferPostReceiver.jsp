...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Receiver Transfer Post Report</h3>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<TranferPostDto> list = service.getAllTransferPostReciver(
						...
						"yyyy-MM-dd", "dd-MM-yyyy")%></td>
								...
								<%-- <td
												...
												href="transportPostItemReport.jsp?id=<%=dto.getId()%>">
