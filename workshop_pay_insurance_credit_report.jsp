...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Insurance WS claim</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center; background: #e2d1d1">Credit
									Entry</th>
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<WorkshopDto> list = service.getAllWorkshopApprovalPenndingCredit(
