...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending for bill no</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<!-- <th style="text-align: center; background: #e2d1d1; display: none;">Credit
									Entry</th> -->
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<WorkshopDto> list = service
										.getAllWorkshopApprovalPenndingBill(branch_id, config,
												request);
							...
							<tr>
								...
								<%
									if (!dto.getBill_no().equalsIgnoreCase("0")) {
								%>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold; background: #d2c1c1"><a
									href="add_workshop_billno.jsp?id=<%=dto.getId()%>"> Bill No
								</a></td>
						...
						"yyyy-MM-dd", "dd-MM-yyyy")%></td>
								...
								<%-- <%
									if (dto.getInsurance_credit_status().equalsIgnoreCase("Done")) {
								%>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold; background: #e2d1d1">Done</td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold; background: #e2d1d1"><a
									href="workshop_insurance_credit.jsp?id=<%=dto.getId()%>">
										Credit Entry </a></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getInsurance_credit_cheque_date()%></td>
								<td
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getBill_date()%></td>
