...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Received Payment Pending Report</h3>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<ReseviePaymentDto> list = service
										.getAllReciveAmountReport(config, request);
							...
							<tr>
								...
								<td style="text-align: center;"><a
									href="reciveAmountSategeFirststatus.jsp?id=<%=dto.getId()%>">
										<b> Verify & OK </b>
								</a></td>
