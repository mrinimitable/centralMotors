...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Claim Loyalty Bonus</h3>
...
<%
											...
											ArrayList<DamageVehicleDto> list = service
													.getPendingClaimLotteryBonus(branch_id, config, request);
						...
						"yyyy-mm-dd", "dd-mm-yyyy")%></td>
											...
											<td
												...
												href="add_lottery_claim.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
													Claim Entry </a></td>
