...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Collect From Customer Rto Paper</h3>
						...
						<tbody style="background: #fff;">
							...
							<tr>
								...
								<td style="text-align: center;"><a
									href="RtoPaperImage/<%=dto.getId()%>.zip" download><i
										class="fa fa-bars" aria-hidden="true" title="Download"></i> </a>"Download"</td>


								<td style="text-align: center;"><a
									href="edit_rto_collect_to_customer.jsp?id=<%=dto.getId()%>"><i
										class="fa fa-bars" aria-hidden="true" title="Download"></i> </a></td>
