								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										...
										<input type="text" name="model_name" id="model_name"
											value="<%=dto.getModel_name() %>" readonly="readonly" class="form-control"> 
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										...
										<input type="text" name="variant_name" id="variant_name"
											value="<%=dto.getVariant_name() %>" readonly="readonly" class="form-control">
									...
									<input type="hidden" name="Variant_corporate_bonus_amount"
										...
										id="variant_exchange_bonus_amount">
										
										 <input
										type="hidden" name="showroom_price" id="showroom_price">
									<input type="hidden" name="rto_tax_price" id="rto_tax_price">
									<input type="hidden" name="insurance_price"
										id="insurance_price"> <input type="hidden"
										name="gst_per" id="gst_per"> <input type="hidden"
										name="cess_per" id="cess_per"> <input type="hidden"
										name="tcs_per" id="tcs_per"> <input type="hidden"
										name="handling_charges" id="handling_charges"> <input
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										...
										<%-- <select id="color_id_fk" name="color_id_fk"
											...
											value="<%=dto.getColor_name() %>" readonly="readonly" class="form-control">
									</div>
								</div>
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="complete_date" id="complete_date"
											placeholder="Date" value="<%=cur_date%>"
