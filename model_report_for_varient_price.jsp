...
<body>
	...
	<div class="row_my">
		...
		<h2 style="text-align: center;">All Model</h2>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">All Date</th>
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<ModelDto> list = service.getAllModel(config, request);
							...
							<tr>
								...
								<td style="text-align: center;"><a
									href="all_date_for_varinet.jsp?id=<%=dto.getId()%>"> <i
