...
<body>
	...
	<h3 style="text-align: center;">Pay Rto Tax</h3>
	...
	<div class="col-md-12">
		...
		<div class="col-md-8" style="padding: 0px;">
						...
						<div class="right_side">
							<form action="RtoTaxServlet" id="new" method="post">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="tax_date" id="tax_date"
