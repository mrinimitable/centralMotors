 ...
 --%>
					...
					<div style="width: 38%; font-size: 11px; float: right;">
						...
						<div>
							...
							<%=LogFileService.changeFormate(dto.getQuotation_date(),
				...
				<table style="width: 100%;" border="0" cellpadding="0"
					...
					<tbody>
						...
						<tr style="text-align: center; font-size: 11px;">
							...
							<td><%=dto.getAccessories_charges()%></td>
						...
						<table style="width: 100%; line-height: 15px;">
							<tbody>
								...
								<tr style="font-size: 11px;">
									...
									<td align="left" style="padding-right: 2px;"><%=dto.getTotal_amount()%></td>
								</tr>
				...
				<table style="width: 100%; line-height: 15px;">
					<tbody>
						...
						<tr style="font-size: 15px;"">
							...
							<td style="padding-right: 2px;"><%=dto.getRemark()%></td>
