...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Claim Corporate Bonus</h3>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							...
							<%
											...
											ArrayList<DamageVehicleDto> list = service.getPendingClaimCorporateBonus(
						...
						"yyyy-mm-dd", "dd-mm-yyyy")%></td>
											...
											<td
												...
												href="add_corporate_claim.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
													Claim Entry </a></td>
