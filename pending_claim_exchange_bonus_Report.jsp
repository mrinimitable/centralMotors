...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Claim Exchange Bonus</h3>
...
<%
											...
											ArrayList<DamageVehicleDto> list = service.getPendingClaimExchangeBonus(
						...
						"yyyy-mm-dd", "dd-mm-yyyy")%></td>
											...
											<td
												...
												href="add_exchange_claim.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
													Claim Entry </a></td>
