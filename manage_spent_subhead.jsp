...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Manage Finance Branch</h3>
		
			<div class="col-md-12" style="text-align: center;">

			</br> <a href="Add_Spent_SubHead.jsp" class="submit">
								<button class="submit">Add Spent SubHead</button>
							</a>
		</div>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
											...
											<th style="text-align: center;">Spent Head</th>
...
<%
											...
											ArrayList<SpentDto> list = service.getAllSpentSubHead(config,
													request);
										...
										<tr>
											...
											<td style="text-align: center;"><%=dto.getSpent_sub_head_name()%></td>
											<td style="text-align: center;"><%=dto.getSpent_head_name()%></td>
											<td style="text-align: center; text-transform: capitalize;"><%=dto.getSTATUS()%></td>
											<td style="text-align: center;"><a
												href="edit_spent_subhead.jsp?id=<%=dto.getId()%>"> <i
