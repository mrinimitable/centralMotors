...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Burhanpur Payment Approve Request</h3>
...
<%
										...
										String branch="3";
											...
											ArrayList<SpentDto> list = service.getAllApproverSpentAmountNotOnlyCash(
 ...
 %> </a>
											...
											<td style="text-align: center;"><a
												href="approve_spend_payment.jsp?id=<%=dto.getId()%>">Pay
													Amount </a></td>
