...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Manage Collect Post</h3>
				...
				<div class="table-responsive">
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
								...
								<%
											CollectPostService service = new CollectPostService();
											ArrayList<CollectPostDto> list = service.getAllCollectPost(config,
													request);
											for (CollectPostDto dto : list) {
										%>


										<tr>
											<td style="text-align: center;"><%=list.indexOf(dto) + 1%></td>
											<td style="text-align: center;"><%=LogFileService.changeFormate(dto.getPost_date(),
						"yyyy-MM-dd", "dd-MM-yyyy")%></td>
											<td style="text-align: center;"><%=dto.getPost_by()%></td>
											<td style="text-align: center; text-transform: capitalize;"><%=dto.getRemark()%></td>

											<td style="text-align: center; text-transform: capitalize;"><%=dto.getFile_no()%></td>
											<td style="text-align: center; text-transform: capitalize;"><%=dto.getSTATUS()%></td>
											<%-- <td style="text-align: center;">
											 <a href="editCollectPost.jsp?id=<%=dto.getId()%>"> 
