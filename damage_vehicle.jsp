...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Damage Vehicle Report</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">Amt. Difference</th>
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<DamageVehicleDto> list = service.getAllDamageVehicle(
										config, request);
							...
							<tr>
								...
								<%
									if (dto.getClaim_status().equalsIgnoreCase("Done")) {
								%>
								...
								<td
									...
									href="add_damage_claim.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
										Claim Entry </a></td>
								<%
									}
								%>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(dto.getClaim_date(),
						"yyyy-mm-dd", "dd-mm-yyyy")%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getClaim_no()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getClaim_amount()%></td>
								...
								<%
									if (dto.getCredit_note_status().equalsIgnoreCase("Done")) {
								%>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><a
									href="add_damage_vehicle_credit.jsp?id=<%=dto.getId()%>&&Vehicle_id=<%=dto.getVehicle_id_fk()%>">
										Credit Entry </a></td>
								<%
									}
								%>
						...
						dto.getCredit_note_date(), "yyyy-mm-dd", "dd-mm-yyyy")%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=Float.parseFloat(dto.getClaim_amount())
						- Float.parseFloat(dto.getCredit_note_amount())%></td>
