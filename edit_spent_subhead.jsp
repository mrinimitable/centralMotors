...
<body>
	...
	<h3 style="text-align: center;">Edit Spent SubHead</h3>
	...
	<div class="col-md-12">
		...
		<div class="col-md-8" style="padding: 0px;">
						...
						<div class="right_side">
							...
							SpentDto dto = service.getspentSubheadByHeadId(id, request, config);
							...
							%>
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										...
										%>
											<option
												<%if(dto.getSpent_head_id()==fdto.getSpent_head_id()) {out.print("Selected='selected'");}%>
												value="<%=fdto.getSpent_head_id()%>"><%=fdto.getSpent_head_name() %></option>
										 ...
										 <input type="hidden" name="spent_head_name"
											id="spent_head_name" value="<%=dto.getSpent_head_name()%>">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="NAME" id="NAME" onblur="checkName();"
											...
											value="<%=dto.getSpent_sub_head_name()%>"> <input
											type="hidden" name="id" id="id" value="<%=dto.getId()%>">
