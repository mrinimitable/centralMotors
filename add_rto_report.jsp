					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">Rto</th>
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<PurchaseVehicleDto> list = service
										.getAllPendingRtoPaperByBranch(branch_id, config, request);
							...
							<tr>
								...
								<%
									if (dto.getRto_paper_status().equalsIgnoreCase("Done")) {
								%>
								...
								<%
											...
											if (track_dto.getCollect_rto_paper_from_customer_first().equals("yes")) {
								%>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><a
									href="rto_paper.jsp?id=<%=dto.getId()%>"> <i
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;">No</td>
								<%
									}
