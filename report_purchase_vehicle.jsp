...
<body>
	...
	<div class="row_my">
		...
		<h2 style="text-align: center;">Transfer To Other Branch</h2>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<PurchaseVehicleDto> list = service.getAllPurchaseVehicle(
										config, request);
							...
							<tr>
								...
								<td
									...
									<%=LogFileService.changeFormate(dto.getPurchase_date(),
