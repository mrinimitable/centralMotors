...
<body>
	...
	<div class="col-md-12">
		...
		<div class="col-md-8" style="padding: 0px;">
			...
			<%
				int update_status_id = 3;
												String cur_date = LogFileService
														.changeFormateOfCurrentDate("yyyy-MM-dd");
											
											int workshop_id = Integer.parseInt(request
													.getParameter("id") == null ? "0" : request
													.getParameter("id"));
											...
											WorkshopDto dto = pur_service.getWorkshopById(workshop_id, request, config);
			%>

			<div class="right_side">

				<form action="WorkshopServlet" id="form1" method="post">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="request_date" id="request_date"
								placeholder="saleing_date" value="<%=dto.getRequest_date()%>"
								class="form-control">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="customer_name" id="customer_name"
								...
								value="<%=dto.getCustomer_name()%>" class="form-control"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="customer_mobile_no"
								...
								value="<%=dto.getCustomer_mobile_no()%>" class="form-control"
								style="background: #ffcbcb"> <input type="hidden"
								name="update_status_id" id="update_status_id"
								value="<%=update_status_id%>"> <input type="hidden"
								name="id" id="id" value="<%=workshop_id%>"> <input
								type="hidden" name="creator_id_fk_aprovel"
								id="creator_id_fk_aprovel" value="<%=creator_id%>"> <input
								type="hidden" name="creator_id_fk_name" id="creator_id_fk_name"
								value="<%=dto.getCreator_id_fk_name()%>"> <input
								type="hidden" name="creator_id_fk_mobile"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="jobcard_no" id="jobcard_no"
								placeholder="Enter jobcard_no" value="<%=dto.getJobcard_no()%>"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="promish_sate" id="promish_sate"
								placeholder="saleing_date" value="<%=dto.getPromish_sate()%>"
								class="form-control">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="bill_amount" id="bill_amount"
								...
								value="<%=dto.getBill_amount()%>" onblur="balanceAmt();">
							...
							<table style="width: 100%">
								<tr align="center">
									<td><input type="radio" name="accidental_status"
										checked="checked"
										<%if("No".equalsIgnoreCase(dto.getAccidental_status())) {%>
										...
										<%if("Yes".equalsIgnoreCase(dto.getAccidental_status())) {%>
										checked="checked" <%}%> onclick="showHidefinance(this.value)" />
										<strong
						...
						<div class="col-md-12" style="padding: 0px;">
							...
							<div class="col-md-6">
								...
								<select id="insurance_company_id_fk"
									...
									<option
										<%if(mDto.getId()== dto.getId()) { out.print("Selected='selected'");}%>
								...
								</select> <input type="hidden" name="creator_id_fk_aprovel"
									id="creator_id_fk_aprovel" value="<%=creator_id%>"> <input
									type="hidden" name="session" id="session"
									value="<%=session_year%>"> <input type="hidden"
									name="branch_id_fk" id="branch_id_fk" value="<%=branch_id%>" />
								<input type="hidden" name="insurance_company_name"
									id="insurance_company_name"
									<%=dto.getInsurance_company_name()%>>
						...
						<div class="col-md-12" style="padding: 0px;">
							...
							<div class="col-md-6">
								<input type="text" name="Insurance_date" id="insurance_date"
									placeholder="Date" value="<%=dto.getInsurance_date()%>"
									class="form-control">
						...
						<div class="col-md-12" style="padding: 0px;">
							...
							<div class="col-md-6">
								<input type="text" name="insurance_amount" id="insurance_amount"
									...
									class="form-control" value="<%=dto.getInsurance_amount()%>">
					...
					<div class="col-md-12" style="padding: 0px; display: none;">
						...
						<div class="col-md-6">
							<input type="text" name="diposit_amount" id="diposit_amount"
								...
								value="<%=dto.getDiposit_amount()%>" onblur="balanceAmt();">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="booking_amount" id="booking_amount"
								placeholder="" class="form-control"
								value="<%=dto.getBooking_amount()%>" onblur="balanceAmt();">
						...
						<table style="width: 100%">
							<tr align="center">
								<td><input type="radio" name="diposit_mode"
									...
									checked="checked" <%}%> onclick="showHideDD(this.value)" /> <strong
									style="margin-left: 5px; font-size: 14px; font-weight: normal;">
									...
									<%if("Online".equalsIgnoreCase(dto.getDiposit_mode())) {%>
							...
							<div class="col-lg-12 col-md-12 " id="ddDiv"
								...
								<div class=" col-md-3">
									<select id="diposit_bank" name="diposit_bank"
										...
										%>
										<option
											<%if (dto.getDiposit_bank().equalsIgnoreCase((mDto.getBank_name()))) {
				out.print("Selected='selected'");
			}%>
											value="<%=mDto.getBank_name()%>"><%=mDto.getBank_name()%></option>
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="pay_diposit" id="pay_diposit"
								placeholder="" value="<%=dto.getPay_diposit()%>"
								class="form-control" style="background: #ffcbcb"
								onblur="balanceAmt();">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<select id="Approve_status" name="Approve_status"
								...
								<option value="Approval">Approve Sale</option>
	...
	var flag1='<%=dto.getAccidental_status()%>';	
