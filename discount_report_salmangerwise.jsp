...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Discount Report</h3>
			...
			<div class="col-md-10">
				...
				<div class="col-md-4">
					<select id="sales_manager_id_fk " name="sales_manager_id_fk "
						...
						<%
							AdminRagistrationService aservice = new AdminRagistrationService();

							ArrayList<AdminRagistrationDto> alist = aservice
									.getAllSalesManagerBYBranchID(branch_id, request, config);
							for (AdminRagistrationDto adto : alist) {
						%>
						<option value="<%=adto.getCreator_id()%>"><%=adto.getNAME()%></option>
						<%
							}
						%>
				...
				<div class="table-responsive">
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							...
							<%
								int sales_manager_id_fk = Integer.parseInt(request
										.getParameter("sales_manager_id_fk ") == null ? "0"
										: request.getParameter("sales_manager_id_fk "));

								PurchaseService service = new PurchaseService();
								ArrayList<PurchaseVehicleDto> list = service
										.getDiscountListBYSalemanagerAndBranch(branch_id,
												sales_manager_id_fk, config, request);
						...
						.getDiposit_cheaqe_reamrk()%></td>
											...
											<td style="text-align: center;"><a
												href="sold_receipt_quotation.jsp?id=<%=dto.getId()%>">Print </a></td>
