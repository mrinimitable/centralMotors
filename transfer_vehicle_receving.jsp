...
<body>
	...
	<h2 style="text-align: center;">Receiving Information</h2>
			...
			<div class="right_side">
				...
				<form action="PurchaseServlet" enctype="multipart/form-data"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="text" value="<%=dto.getVehical_id()%>"
								...
								<input
								type="hidden" name="get_pass_no" id="get_pass_no"
								value="<%=dto.getGet_pass_no()%>">					
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="receiving_date" id="receiving_date"
								placeholder="Receiving Date" value="<%=cur_date%>"
								class="form-control">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="receiving_remark" id="receiving_remark"
								placeholder="Receiving Remark" value=""
								class="form-control">
