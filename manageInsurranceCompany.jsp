...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Manage Insurance Company</h3>


		<div class="col-md-12" style="text-align: center;">

			</br> <a href="addInssuranceCompany.jsp" class="submit"><button class="submit">Add Insurance Company</button></a>
		</div>
					...
					<table class="table table-bordered" id="example">
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<InsuranceCompanyDto> list = service
										.getAllInsuranceCompany(config, request);
								for (InsuranceCompanyDto dto : list) {
							%>
							...
							<tr>
								...
								<td style="text-align: center;"><a
									href="editInsuranceCompany.jsp?id=<%=dto.getId()%>"> <i
