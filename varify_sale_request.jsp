...
<body>
	...
	<h3 style="text-align: center;">Aprovel Sale Request</h3>
				...
				<form action="SaleRequestServlet" enctype="multipart/form-data"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="hidden" name="model_id_fk" id="model_id_fk"
								value="<%=dto.getModel_id_fk()%>" class="form-control"
							...
							<input type="hidden" name="creator_id_fk_approve"
								id="creator_id_fk_approve" value="<%=creator_id%>">

							<%--  <input type="hidden"
								name="creator_id_fk" id="creator_id_fk"
								value="<%=dto.getCreator_id_fk()%>"> --%>
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="text" name="variant_name" id="variant_name"
								...
								value="<%=dto.getVariant_id_fk()%>" class="form-control"
								readonly="readonly"> <input type="hidden"
								name="showroom_price" id="showroom_price"
							...
							<input type="hidden" name="tcs_per" id="tcs_per"
								...
								value="<%=dto.getTcs_amount()%>">



							<%-- 		<input
											type="hidden" name="rsa_amount" id="rsa_amount"
											value="<%=dto.getRsa_amount()%>"> <input
											type="hidden" name="extended_warranty_amount"
											id="extended_warranty_amount"
											value="<%=dto.getExtended_warranty_amount()%>"> <input
											type="hidden" name="other_charges" id="other_charges"
											value="<%=dto.getOther_charges()%>">  --%>

							<input type="hidden" name="showroom_gross_price"
								id="showroom_gross_price"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="text" name="color_name" id="color_name"
								value="<%=dto.getColor_name()%>" class="form-control"
								readonly="readonly"> <input type="hidden"
								name="color_id_fk" id="color_id_fk"
								value="<%=dto.getColor_id_fk()%>" class="form-control"
								readonly="readonly">
						</div>
					</div>
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="sales_manager_name"
								id="sales_manager_name" placeholder="sales_manager_name"
								class="form-control" value="<%=dto.getSales_manager_name()%>"
								readonly="readonly"> <input type="hidden"
								name="sales_manager_id_fk" id="sales_manager_id_fk"
								value="<%=dto.getSales_manager_id_fk()%>"> <input
								type="hidden" name="sales_manager_mobile"
								id="sales_manager_mobile"
								value="<%=dto.getSales_manager_mobile()%>">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="sales_consultant_name"
								id="sales_consultant_name" placeholder="sales_consultant_name"
								class="form-control" value="<%=dto.getSales_consultant_name()%>"
								readonly="readonly"> <input type="hidden"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="text" name="accessories_amount"
								...
								value="<%=dto.getAccessories_amount()%>"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="other_bonus_amount"
								...
								value="<%=dto.getOther_bonus_amount()%>">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-3">
							<input type="text" name="exchange_bonus_amount"
								...
								onblur="getfinal_price();CheckExchangeBonus();" placeholder=""
								value="<%=dto.getExchange_bonus_amount()%>">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-3">
							<input type="text" name="lottery_bonus_amount"
								...
								onblur="getfinal_price(); CheckLoyaltBonus();" placeholder=""
								value="<%=dto.getLottery_bonus_amount()%>">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-3">
							<input type="text" name="corporate_bonus_amount"
								...
								onblur="getfinal_price(); CheckCorporateBonus();" placeholder=""
								value="<%=dto.getCorporate_bonus_amount()%>">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="pay_diposit_amount_cash"
								...
								class="form-control" onblur="balanceAmt();"> <input
								type="hidden" name="pay_diposit_amount" id="pay_diposit_amount"
								placeholder="" value="<%=dto.getPay_diposit_amount()%>"
									...
									<tr>
										...
										<td><div class="col-md-12"
												...
												<input type="hidden" id="item_id<%=row_id%>" name="Item_id"
													...
													type="hidden" id="cat_name<%=row_id%>" name="Cat_name"
													value="<%=item_dto.getCat_name()%>" />
