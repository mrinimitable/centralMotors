...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Post Transfer Other Branch</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">Post No</th>
								<th style="text-align: center;">Remark</th>
								<th style="text-align: center;">By Person</th>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<TranferPostDto> list = service.getAllTransferPostSender(
						...
						"yyyy-MM-dd", "dd-MM-yyyy")%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getPost_by_name()%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getPost_old_no()%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getBy_person()%></td>


								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><a
									href="transportPostItemReport.jsp?id=<%=dto.getId()%>"> <i
										class="fa fa-pencil-square-o" aria-hidden="true" title=""></i>
								</a></td>
