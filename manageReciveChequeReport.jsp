...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Received Payment Complete Report</h3>
	...
	<%
											...
											ArrayList<ReseviePaymentDto> list = service
													.getAllChequeReciveAmountDetailReport(branch_id, config,
															request);
						...
						"yyyy-MM-dd", "dd-MM-yyyy")%>
											...
											<td style="text-align: center;"><%=dto.getCustomer_name() == null ? "N/A" : dto
						.getCustomer_name()%></td>


											<td style="text-align: center;"><%=dto.getCustomer_mobile() == null ? "N/A" : dto
						.getCustomer_mobile()%></td>
 ...
 %> </a>
						...
						"yyyy-MM-dd", "dd-MM-yyyy")%></td>
											...
											<%-- 	
											<td
												style="text-align: center; "><a href="EditchequeDetailForBank.jsp?id=<%=dto.getId()%>">
												<i
...
<%-- 
 ...
 <a href="EditchequeDetailForBank.jsp?id=<%=dto.getId()%>"> Ready
													to Bank </a> <%
 	}
 		} else {
 %> Done <%
 ...
 %>
											...
											<td
												...
												<a href="ViewNoteDetail.jsp?id=<%=dto.getId()%>">View </a>
												 </td> --%>
