...
<script>
	$(function() {
		$('#diposit_cheaqe_date1').datetimepicker();
	});
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="saleing_date" id="saleing_date"
								...
								type="hidden" name="creator_id_fk_sale" id="creator_id_fk_sale"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="old_vehicle_value"
								...
								class="form-control" onblur="getfinal_price();"
								readonly="readonly">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="address_sale" id="address_sale"
								...
								value="<%=dto.getAddress_sale()%>" readonly="readonly">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="adhar_no" id="adhar_no"
								...
								value="<%=dto.getAdhar_no()%>" readonly="readonly">
							...
							<table style="width: 100%">
								<tr align="center">
									<td><input type="radio" name="finance_available"
										...
										onclick="javascript: return false;" /> <strong
						...
						<div class="col-md-12" style="padding: 0px;">
							...
							<div class="col-md-6">
								<input type="text" name="finance_date" id="finance_date"
									...
									value="<%=dto.getFinance_date()%>" readonly="readonly">
						...
						<table style="width: 100%">
							<tr align="center">
								<td><input type="radio" name="diposit_mode"
									...
									checked="checked" <%}%> name="diposit_mode"
									onclick="javascript: return false;" value="Swap" /> <strong
