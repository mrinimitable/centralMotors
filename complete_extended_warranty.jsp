...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Pending Rsa Amount</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
											...
											<th style="text-align: center;">Dms Reference No</th>
						...
						<tbody style="background: #fff;">
										...
										<%
											...
											ArrayList<DamageVehicleDto> list = service
													.getCompleteExtended_warranty(branch_id, config, request);
										...
										<tr>
											...
											<td
												style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getExtended_warranty()%></td>



											<td
												style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(
						dto.getDms_reference_date(), "yyyy-mm-dd", "dd-mm-yyyy")%></td>

											<td
												style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getDms_reference_no()%></td>
