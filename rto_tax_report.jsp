...
<%@page import="com.dto.RtoTaxDto"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.service.RtoTaxService"%>
<html>
<head>
...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Rto Tax Report</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							<tr>
								...
								<th style="text-align: center;">Rto Date</th>
						...
						<tbody style="background: #fff;">
							<%
								RtoTaxService service = new RtoTaxService();
								ArrayList<RtoTaxDto> list = service.getAllRtoTax(config, request,
										branch_id);
								for (RtoTaxDto dto : list) {
							...
							<tr>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=LogFileService.changeFormate(dto.getTax_date(),
						"yyyy-mm-dd", "dd-mm-yyyy")%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getTax_amount()%></td>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getVoucher_no()%></td>


								<td style="text-align: center; display: none;"><a
