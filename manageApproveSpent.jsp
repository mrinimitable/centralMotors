...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Spent Complete Report</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">Return Coin Rs 1</th>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<SpentDto> list = service.getAllSpentCompleteOnlyCash(
							...
							<tr>
								...
								<td style="text-align: center;"><a
									href="receipt_payment_voucher.jsp?sadfjshakhfdsakj=<%=dto.getId()%>">Print
								</a></td>
