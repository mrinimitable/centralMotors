...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">More Than Accessories Price Accessories Report</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							<tr>
								...
								<th style="text-align: center;" width="5%">Billing Date</th>
								...
								<th style="text-align: center;" width="5%">Billing Amount</th>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<AccessoriesDto> list = service.getAllCompleteAccessoriesMoreThanBillAmount(
						...
						"yyyy-MM-dd", "dd-MM-yyyy")%></td>
								...
								<td style="text-align: center;"><%=LogFileService.changeFormate(dto.getBilling_date(),
						"yyyy-MM-dd", "dd-MM-yyyy")%></td>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getBill_price()%></td>
