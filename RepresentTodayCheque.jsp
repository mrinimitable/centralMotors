...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Represent Today Cheque</h3>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
											...
											<th style="text-align: center;">Check Clear</th>
						...
						<tbody style="background: #fff;">
										...
										<%
											...
											ArrayList<ReseviePaymentDto> list = service
													.getRepresentTodayCheque(branch_id,config, request);
 ...
 %> </a>
						...
						"yyyy-MM-dd", "dd-MM-yyyy")%>
											...
											<td style="text-align: center;"><%=dto.getRemark() == null ? "N/A" : dto.getRemark()%></td>
												...
												<td style="text-align: center;"><a href="EditchequeDetailForBank.jsp?id=<%=dto.getId()%>"> Ready
													to Bank </a></td>
