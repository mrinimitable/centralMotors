...
<body>
	...
	<div class="row">
		...
		<h3 style="text-align: center;">Add Rto Tax</h3>
						...
						<tbody style="background: #fff;">
							<%
								...
								ArrayList<PurchaseVehicleDto> list = service
										.getAllPendingRtoTaxByBranch(branch_id, config, request);
							...
							<tr>
								...
								<%
									if (dto.getRto_tax_status().equalsIgnoreCase("Done")) {
								%>
								...
								<%
											...
											if (track_dto.getRto_paper_report().equals("yes")) {
								%>

								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><a
									href="rto_tax.jsp?id=<%=dto.getId()%>"> <i
