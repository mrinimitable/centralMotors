...
<body>
			...
			<div class="right_side">
				...
				<form action="TransactionServlet" id="form1" name="form1"
					...
					<div class="col-md-12">
						...
						<div class="col-md-9">
							<select class="form-control input_a" name="bank_id_fk"
								id="bank_id_fk" onclick="checkBankName();">
					...
					<input type="hidden" name="branch_id_fk" id="branch_id_fk"
						value="<%=branch_id%>" /> <input type="hidden" name="bank_name"
						id="bank_name" value="" /> <input type="hidden"
	...
	<script type="text/javascript">
		function checkBankName() {
			var code_a = $("#bank_id_fk :selected").val();
			...
			if (code_a != "" && code_a != null) {
				...
				$.ajax({
					...
					success : function(msg) {
						...
						var bank_name_val = document.getElementById("bank_name_val").value;
						
						document.getElementById('bankbranch').value = branch;
						document.getElementById('Account_no').value = account;
						document.getElementById('bank_name').value = bank_name_val;
