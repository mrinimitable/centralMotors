...
<script>
	$(function() {
		$('#dms_reference_date').datetimepicker();
	});
</script>
...
<body>
	...
	<h3 style="text-align: center;">Add Extended Warranty Reference No</h3>
	...
	<div class="col-md-12">
		...
		<div class="col-md-8" style="padding: 0px;">
			...
			<div class="right_side">
				<form action="ExchangeBonusServlet" id="new" method="post">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							...
							<input type="text" value="<%=dto.getVehical_id()%>"
								...
								type="hidden" name="update_status_id" value="4">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-2"></div>
						<div class="col-md-6" align="center">
							<label>Dms Reference No INFO</label>
						</div>
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="dms_reference_date"
								id="dms_reference_date" placeholder="dms_reference_date"
					...
					<div class="col-md-12" style="padding: 0px;">
						<div class="col-md-2"></div>
						<div class="col-md-3">
							<label> Dms Reference No</label>
						</div>
						<div class="col-md-6">
							<input type="text" name="dms_reference_no" id="dms_reference_no"
								placeholder="dms_reference_no" value="" class="form-control">
