...
<body>
	...
	<h3 style="text-align: center;">Collect From Customer</h3>
			...
			<div class="right_side">
				<form action="RtoPaperServlet" enctype="multipart/form-data"
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<%
							if ("yes".equals(dto.getReceive_adhar_card())) {
						%>

						<div class="col-md-1">


							<input type="checkbox" name="receive_adhar_card" value="yes"
								<%if ("yes".equals(dto.getReceive_adhar_card())) {
					out.print("Checked='checked'");
				}%>
								onchange="getcurrent_value(this);"
								onblur="getcurrent_value(this);" onclick="return false;"></input>
					...
					out.print("Checked='checked'");
								...
								onchange="getcurrent_value(this);"
								onblur="getcurrent_value(this);"></input>
						...
						<div class="col-md-2">
							<input type="text" name="receive_adhar_card_date"
								id="receive_adhar_card_date" placeholder="Date"
								value="<%=dto.getReceive_adhar_card_date()%>"
								class="form-control" readonly="readonly">
						...
						<%
							if ("yes".equals(dto.getReceive_pan_card())) {
						%>


						<div class="col-md-1">
							<input type="checkbox" name="receive_pan_card"
								id="receive_pan_card" value="yes"
								<%if ("yes".equals(dto.getReceive_pan_card())) {
					out.print("Checked='checked'");
				}%>
					...
					out.print("Checked='checked'");
						...
						<div class="col-md-2">
							<input type="text" name="receive_pan_card_date"
								id="receive_pan_card_date" placeholder="Date"
								value="<%=dto.getReceive_pan_card_date()%>" class="form-control"
								readonly="readonly">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<%
							if ("yes".equals(dto.getReceive_paichay_patr())) {
						%>
						...
						<div class="col-md-1">
							<input type="checkbox" name="receive_paichay_patr"
								id="receive_paichay_patr" value="yes"
								<%if ("yes".equals(dto.getReceive_paichay_patr())) {
					out.print("Checked='checked'");
				}%>
					...
					out.print("Checked='checked'");
						...
						<div class="col-md-2">
							<input type="text" name="receive_paichay_patr_date"
								id="receive_paichay_patr_date" placeholder="Date"
								value="<%=dto.getReceive_paichay_patr_date()%>"
								class="form-control" readonly="readonly">
						...
						<%
							if ("yes".equals(dto.getReceive_photo())) {
						%>
					...
					out.print("Checked='checked'");
						...
						<div class="col-md-2">
							<input type="text" name="receive_photo_date"
								id="receive_photo_date" placeholder="Date"
								value="<%=dto.getReceive_photo_date()%>" class="form-control"
								readonly="readonly">
