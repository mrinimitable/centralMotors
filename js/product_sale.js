...
/*		var newCell = newRow.insertCell(0);
		...
		newCell.innerHTML = item_code.toUpperCase() + '<input id="item_code'
				...
				+ '"><input id="item_id' + preWorkExpIndex
				+ '" type="hidden" name="Item_id" value="' + item_id + '">';
		newCell.setAttribute("align", "center");
...
/*function findTotal() {
	...
	document.getElementById('accessories_amount_span').innerHTML = parseFloat(
			total_amt).toFixed(2);

	document.getElementById('accessories_amount').value = parseFloat(
			total_amt).toFixed(2);
