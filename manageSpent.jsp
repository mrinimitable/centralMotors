...
<body>
					...
					<table class="table table-bordered" id="example">
						<thead class="thead_bg">
							...
							<tr>
								...
								<th style="text-align: center;">Against Status</th>
								<th style="text-align: center;">Date</th>
								<th style="text-align: center;">Branch</th>
								<th style="text-align: center;">Head</th>
								<th style="text-align: center;">Sub Head</th>
								<th style="text-align: center;">Spent BY</th>
								<th style="text-align: center;">Spent To</th>
						...
						<tbody style="background: #fff;">
							...
							<%
								...
								ArrayList<SpentDto> list = service.getAllSpentAmountReport(config,
										request);
							...
							<tr>
								...
								<td
									style="text-align: center; text-transform: capitalize; font-weight: bold;"><%=dto.getAgainst_status()%></td>
						...
						.getSpent_sub_head_name()%></td>
								...
								<td style="text-align: center;"><%=dto.getRemark() == null ? "N/A" : dto.getSpend_by()%></td>

								<td style="text-align: center;"><%=dto.getRemark() == null ? "N/A" : dto.getPay_to()%></td>
 ...
 %> </a>
								...
								<%-- 	<td style="text-align: center;"><a
												href="approve_spend_payment.jsp?id=<%=dto.getId()%>">Verify
													& Ok </a></td>
