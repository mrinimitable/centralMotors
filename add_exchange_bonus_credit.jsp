...
<body>
	...
	<h3 style="text-align: center;">Add Exchange Bonus</h3>
	...
	<div class="col-md-12">
		...
		<div class="col-md-8" style="padding: 0px;">
			...
			<%
				...
				int exchange_id = Integer.parseInt(request
						.getParameter("exchange_id") == null ? "0" : request
						.getParameter("exchange_id"));
				...
				DamageVehicleDto exchange_dto = exchange_service.getExchangeById(
						id, request, config);
			%>
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="claim_date" id="claim_date"
								...
								value="<%=exchange_dto.getClaim_date()%>"
								class="form-control" readonly="readonly">
					...
					<div class="col-md-12" style="padding: 0px;">
						...
						<div class="col-md-6">
							<input type="text" name="claim_amount" id="claim_amount"
								...
								value="<%=exchange_dto.getClaim_amount()%>"
								class="form-control" readonly="readonly">
