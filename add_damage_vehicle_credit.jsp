...
<body>
	...
	<h3 style="text-align: center;">Credit Note Damage Vehicle</h3>
	...
	<div class="col-md-8" style="padding: 0px;">
						...
						<%
							...
							DamageVehicleDto exchange_dto = exchange_service
									.getDamageVehicleById(id, request, config);
						%>

						<div class="right_side">
							<form action="DamageVehicleServlet" id="new" method="post">
								...
								<div class="col-md-12" style="padding: 0px;">
									...
									<div class="col-md-6">
										<input type="text" name="claim_no" id="claim_no"
											...
											value="<%=exchange_dto.getClaim_no()%>"
											class="form-control" readonly="readonly">
